...
const Map: React.FC<MapProps> = ({ center, onClick, setLocationName }) => {
  ...
  return (
    <MapContainer center={center} zoom={15} className="h-[50vh] w-full">
      <ChangeView center={center} />
      <TileLayer
        url={`https://tile.thunderforest.com/neighbourhood/{z}/{x}/{y}.png?apikey=ffe6472febbe4e60ab3e6d2ed975cde9`}
      />
